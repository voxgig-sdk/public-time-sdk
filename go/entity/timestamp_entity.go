...
import (
	...
	vs "github.com/voxgig-sdk/public-time-sdk/go/utility/struct"
)

type TimestampEntity struct {
	name    string
	client  *core.PublicTimeSDK
...
func NewTimestampEntity(client *core.PublicTimeSDK, entopts map[string]any) *TimestampEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *TimestampEntity) GetName() string { return e.name }
...
func (e *TimestampEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *TimestampEntity) Deleted() bool {
	return e.deleted
}


func (e *TimestampEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewTimestampEntity(e.client, opts)
}

func (e *TimestampEntity) Data(args ...any) any {
...
func (e *TimestampEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Timestamp; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *TimestampEntity) DataTyped(data ...Timestamp) Timestamp {
	if len(data) > 0 {
		return typedFrom[Timestamp](e.Data(asMap(data[0])))
	}
	return typedFrom[Timestamp](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Timestamp (all fields
// optional at the wire level).
func (e *TimestampEntity) MatchTyped(match ...Timestamp) Timestamp {
	if len(match) > 0 {
		return typedFrom[Timestamp](e.Match(asMap(match[0])))
	}
	return typedFrom[Timestamp](e.Match())
}
...
func (e *TimestampEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *TimestampEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// TimestampLoadMatch and returns an Timestamp. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *TimestampEntity) LoadTyped(reqmatch TimestampLoadMatch, ctrl map[string]any) (Timestamp, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Timestamp{}, err
	}
	return typedFrom[Timestamp](res), nil
}



func (e *TimestampEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *TimestampEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *TimestampEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *TimestampEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *TimestampEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
