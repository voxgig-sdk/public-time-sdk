...
func NewTimeEntity(client *core.PublicTimeSDK, entopts map[string]any) *TimeEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *TimeEntity) GetName() string { return e.name }
...
func (e *TimeEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *TimeEntity) Deleted() bool {
	return e.deleted
}


func (e *TimeEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewTimeEntity(e.client, opts)
}

func (e *TimeEntity) Data(args ...any) any {
...
func (e *TimeEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Time; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *TimeEntity) DataTyped(data ...Time) Time {
	if len(data) > 0 {
		return typedFrom[Time](e.Data(asMap(data[0])))
	}
	return typedFrom[Time](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Time (all fields
// optional at the wire level).
func (e *TimeEntity) MatchTyped(match ...Time) Time {
	if len(match) > 0 {
		return typedFrom[Time](e.Match(asMap(match[0])))
	}
	return typedFrom[Time](e.Match())
}
...
func (e *TimeEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *TimeEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// TimeLoadMatch and returns an Time. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *TimeEntity) LoadTyped(reqmatch TimeLoadMatch, ctrl map[string]any) (Time, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Time{}, err
	}
	return typedFrom[Time](res), nil
}



func (e *TimeEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *TimeEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *TimeEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *TimeEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *TimeEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
