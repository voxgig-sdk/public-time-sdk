...
const testSeed = `map[string]any{"entity": map[string]any{"time": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "timestamp": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
