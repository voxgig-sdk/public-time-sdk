...
func registerSDKWords(r *eng.Registry, client *sdk.PublicTimeSDK) {
...
func runOp(client *sdk.PublicTimeSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
