...
|---|---|---|
| `ts/` | @voxgig-sdk/public-time-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/public-time-sdk \
      --repository voxgig-sdk/public-time-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/public-time-sdk` shows it, and
`npm trust revoke @voxgig-sdk/public-time-sdk --id=<id>` removes it.
