...
// PublicTime SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class PublicTimeTestFeature extends PublicTimeBaseFeature
{
    ...
    public function init(PublicTimeContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (PublicTimeContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
            ...
            if ($op->name === 'load') {
                ...
                $id = PublicTimeParam::call($fctx, 'id');
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (PublicTimeContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(PublicTimeContext $ctx, $op, $args): array
    {
