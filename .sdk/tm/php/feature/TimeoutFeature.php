...
// PublicTime SDK timeout feature
...
class PublicTimeTimeoutFeature extends PublicTimeBaseFeature
{
    ...
    private function _with_timeout(PublicTimeContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(PublicTimeContext $_ctx, float $ms): void
    {
        $client = $this->client;
