...
class PublicTimeCacheFeature extends PublicTimeBaseFeature
{
    ...
    private function _through(PublicTimeContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
