...
class PublicTimeNetsimFeature extends PublicTimeBaseFeature
{
    ...
    private function _simulate(PublicTimeContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(PublicTimeContext $ctx, array $applied): void
    {
        $client = $this->client;
