...
// PublicTime SDK streaming feature
...
class PublicTimeStreamingFeature extends PublicTimeBaseFeature
{
    ...
    private function _iterate(PublicTimeResult $result): \Generator
    {
    ...
    private function _streamable(PublicTimeContext $ctx): bool
    {
