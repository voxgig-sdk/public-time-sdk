...
// PublicTime SDK utility: graphql
//
...
class PublicTimeGraphql
{
    ...
    // equivalent.
    public static function body(PublicTimeContext $ctx): mixed
    {
    ...
    public static function errors(PublicTimeContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
