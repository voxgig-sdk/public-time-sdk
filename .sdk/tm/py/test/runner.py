...
class PublicTimeTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = PublicTimeTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = PublicTimeTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = PublicTimeTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
