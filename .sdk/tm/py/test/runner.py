...
class PublicTimeTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = PublicTimeTestRunner.getenv("PROJECTNAME_TEST_LIVE")
        override = PublicTimeTestRunner.getenv("PROJECTNAME_TEST_OVERRIDE")
        ...
        explain = PublicTimeTestRunner.getenv("PROJECTNAME_TEST_EXPLAIN")
