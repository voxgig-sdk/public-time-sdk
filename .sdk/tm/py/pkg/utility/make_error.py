...
from projectname_sdk.core.control import PublicTimeControl
from projectname_sdk.core.error import PublicTimeError


def make_error_util(ctx, err):
    if ctx is None:
        from projectname_sdk.core.context import PublicTimeContext
        ctx = PublicTimeContext({}, None)
    ...
    errmsg = ""
    if isinstance(err, PublicTimeError):
        errmsg = err.msg
    ...
    sdk_err = PublicTimeError("", msg, ctx)
