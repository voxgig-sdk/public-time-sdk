...
// PublicTime SDK utility: fetcher

class PublicTimeFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; PublicTimeSDK/1.0)';
    ...
    public static function call(PublicTimeContext $ctx, string $fullurl, array $fetchdef): array
    {
