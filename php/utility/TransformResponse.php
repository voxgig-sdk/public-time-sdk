...
// PublicTime SDK utility: transform_response

require_once __DIR__ . '/../core/Helpers.php';

class PublicTimeTransformResponse
{
    public static function call(PublicTimeContext $ctx): mixed
    {
        ...
        $transform = PublicTimeHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return null;
        }
