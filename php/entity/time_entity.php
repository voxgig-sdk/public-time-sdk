...
class TimeEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new TimeEntity($this->_client, $opts);
    }

    /**
     * @param Time|array $args Time data (assoc-array) to store.
     */
    ...
    /**
     * @return Time|array The current Time data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Time fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Time fields).
     */
     ...
     * Load a single Time.
     *
     * @param TimeLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed TimeLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Time|array The loaded Time as an assoc-array at the
