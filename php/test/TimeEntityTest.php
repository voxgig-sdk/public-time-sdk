...
class TimeEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set PUBLIC_TIME_TEST_TIME_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function time_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("PUBLIC_TIME_TEST_TIME_ENTID");
