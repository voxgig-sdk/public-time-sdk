...
// PublicTime SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = PublicTimeOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(PublicTimeOmni::structfix($now, Struct::undef()))
                        !== json_encode(PublicTimeOmni::structfix($val, Struct::undef()))) {
