...
// PublicTime SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (PublicTimeSDK::test)
...
{
    private const SDK_CLASS = 'PublicTimeSDK';
    ...
    private const SDK_BASE = 'publictime_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../publictime_sdk.php';
