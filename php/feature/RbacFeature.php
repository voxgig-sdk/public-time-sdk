...
class PublicTimeRbacFeature extends PublicTimeBaseFeature
{
    ...
    private function _required(PublicTimeContext $ctx): ?string
    {
    ...
    private function _reject(PublicTimeContext $ctx, string $required): void
    {
    ...
    private function _track(PublicTimeContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
