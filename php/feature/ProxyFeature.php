...
class PublicTimeProxyFeature extends PublicTimeBaseFeature
{
    ...
    public function init(PublicTimeContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (PublicTimeContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
