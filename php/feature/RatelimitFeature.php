...
// PublicTime SDK ratelimit feature
...
class PublicTimeRatelimitFeature extends PublicTimeBaseFeature
{
    ...
    private function _acquire(PublicTimeContext $ctx): void
    {
    ...
    private function _track(PublicTimeContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
