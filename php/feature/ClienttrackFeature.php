...
// PublicTime SDK clienttrack feature
...
class PublicTimeClienttrackFeature extends PublicTimeBaseFeature
{
    ...
    public function PostConstruct(PublicTimeContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'PublicTime-SDK';
