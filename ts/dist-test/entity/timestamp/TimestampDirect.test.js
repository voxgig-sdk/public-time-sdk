...
(0, node_test_1.describe)('TimestampDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.PublicTimeSDK({
    ...
    (0, node_test_1.test)('direct-load-timestamp', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-timestamp', setup.live))
            return;
...
function liveScenariosActive() { return false && process.env.PUBLIC_TIME_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.PublicTimeSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['PUBLIC_TIME_TEST_TIMESTAMP_ENTID'];
    ...
    const client = new __1.PublicTimeSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=TimestampDirect.test.js.map