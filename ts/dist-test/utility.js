...
function envOverride(m) {
    if ('TRUE' === process.env.PUBLIC_TIME_TEST_LIVE ||
        'TRUE' === process.env.PUBLIC_TIME_TEST_OVERRIDE) {
    ...
    m.PUBLIC_TIME_TEST_EXPLAIN = process.env.PUBLIC_TIME_TEST_EXPLAIN || m.PUBLIC_TIME_TEST_EXPLAIN;
    return m;
}
