...
exports.PublicTimeEntityBase = void 0;
const node_util_1 = require("node:util");
// TODO: needs Entity superclass
// `D` is the entity's typed data model (e.g. Advice); subclasses bind it via
// `class AdviceEntity extends PublicTimeEntityBase<Advice>`.
class PublicTimeEntityBase {
    name = '';
    name_ = '';
    Name = '';
    _client;
...
exports.PublicTimeEntityBase = PublicTimeEntityBase;
//# sourceMappingURL=PublicTimeEntityBase.js.map