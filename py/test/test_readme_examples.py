# PublicTime SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions PublicTimeSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both PublicTimeSDK(...) and PublicTimeSDK.test(...) become
#      PublicTimeSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "publictime_sdk"
_SDK_CLASS = "PublicTimeSDK"
