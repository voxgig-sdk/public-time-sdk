...
from publictime_sdk.core.spec import PublicTimeSpec
from publictime_sdk.core.result import PublicTimeResult
from publictime_sdk.core.response import PublicTimeResponse
from publictime_sdk.core.operation import PublicTimeOperation
...
def _err_from_map(m):
    ...
    if msg == "":
        return None
    code = m.get("code", "")
    return PublicTimeError(code, msg)
...
class TestPrimaryUtility:
    ...
    def test_exists(self):
        client = PublicTimeSDK.test(None, None)
    ...
    def test_feature_init_basic(self):
        init_client = PublicTimeSDK.test(None, None)
        ...
        class TestInitFeature(PublicTimeBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "initfeat"
                self.active = True
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(PublicTimeBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_make_result_no_result(self):
        ...
        utility = client._utility
        ctx = _make_test_full_ctx(client, utility)
        ctx.spec = PublicTimeSpec({"step": "start"})
        ctx.result = None
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = PublicTimeSDK.test(None, setup_opts)
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = PublicTimeSDK.test(None, setup_opts)
