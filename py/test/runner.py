...
class PublicTimeTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = PublicTimeTestRunner.getenv("PUBLICTIME_TEST_LIVE")
        override = PublicTimeTestRunner.getenv("PUBLICTIME_TEST_OVERRIDE")
        ...
        explain = PublicTimeTestRunner.getenv("PUBLICTIME_TEST_EXPLAIN")
