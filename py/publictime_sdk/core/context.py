...
from publictime_sdk.core.helpers import get_ctx_prop, to_map
...
class PublicTimeContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(sp, PublicTimeSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, PublicTimeResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, PublicTimeResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return PublicTimeError(code, msg, self)
