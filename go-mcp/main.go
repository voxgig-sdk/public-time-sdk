// Command PublicTime-mcp is an MCP server exposing the PublicTime
// SDK as MCP tools.
//
// Two tools are registered:
//
//	PublicTime_list  — list records of an entity
//	PublicTime_load  — load a single record of an entity
//
