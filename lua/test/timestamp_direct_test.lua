...
describe("TimestampDirect", function()
  it("should direct-load-timestamp", function()
    local setup = timestamp_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-timestamp", setup.live and "live" or "unit")
