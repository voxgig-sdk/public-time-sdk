...
describe("TimeDirect", function()
  it("should direct-load-time", function()
    local setup = time_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-time", setup.live and "live" or "unit")
