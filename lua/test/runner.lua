...
function runner.env_override(m)
  local live = runner.getenv("PUBLIC_TIME_TEST_LIVE")
  local override = runner.getenv("PUBLIC_TIME_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("PUBLIC_TIME_TEST_EXPLAIN")
