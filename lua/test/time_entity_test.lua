...
describe("TimeEntity", function()
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set PUBLICTIME_TEST_TIME_ENTID JSON to run live")
      return
    end
...
function time_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("PUBLICTIME_TEST_TIME_ENTID")
